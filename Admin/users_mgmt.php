<title>TEMPLATE SYSTEM | Manage User</title>
<?php 
      ...
      <div class="col-md-12">
        <form action="../forms/user_update.php" method="POST" enctype="multipart/form-data">
          ...
          <div class="card card-primary card-outline">
            ...
            <div class="card-footer">
              <a href="users.php" class="btn btn-secondary"><i class="fa-solid fa-backward"></i> Cancel</a>
              <button type="submit" class="btn btn-primary float-right" name="update_user" id="submit_button"><i class="fa-solid fa-floppy-disk"></i> Submit</button>
            </div>
          </div>
        </form>
      </div>
